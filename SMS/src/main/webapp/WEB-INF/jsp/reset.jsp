	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-10 p-b-15">
				<form method = "POST" action = "/SMS/reset" class="login100-form validate-form">
					<center>
					...
					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Enter username">
						...
						<span class="focus-input100" data-placeholder="Bronco ID"></span>
					</div>
					...
					<ul class="login-more p-t-25">
						<li class="m-b-8">
							<span class="txt1">
								Please enter your Bronco ID to reset the password for this website.
							</span>
						</li>
					</ul>
				</form>
