           	...
           	<div class="top_menu row m0">
           		<div class="container">
					...
					<div class="float-right">
						...
						<a class="dn_btn" href="https://github.com/haohuynh/CS3560">CS3560 Repository</a>
					</div>
           		</div>	
           	</div>	
            <div class="main_menu">
					...
					<c:forEach begin="0" end="4">
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
							<ul class="nav navbar-nav menu_nav ml-auto">
								<li class="nav-item active"><a class="nav-link" href="https://github.com/haohuynh/CS3560">Home</a></li> 
								...
								<li class="nav-item submenu dropdown">
									...
									<li class="nav-item"><a class="nav-link" href="https://github.com/ohheythereandy">Andy Rosas</a></li>					<li class="nav-item"><a class="nav-link" href="https://github.com/poudyalsaroz">Saroj Poudel</a></li>					<li class="nav-item"><a class="nav-link" href="https://github.com/aboman17">David Roura</a></li>					<li class="nav-item"><a class="nav-link" href="https://github.com/GearM6">Matt</a></li>					<li class="nav-item"><a class="nav-link" href="https://github.com/haohuynh">Hao Huynh</a></li>
